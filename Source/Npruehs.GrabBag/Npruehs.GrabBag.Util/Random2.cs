// --------------------------------------------------------------------------------------------------------------------
// <copyright file="Random2.cs" company="Nick Pruehs">
...
namespace Npruehs.GrabBag.Util
{
    ...
    public class Random2
    {
        ...
        {
            return (int)(this.NextUInt64() % (ulong)maxExclusive);
        }
        ...
        {
            return (long)(this.NextUInt64() % (ulong)maxExclusive);
        }
