// --------------------------------------------------------------------------------
// <copyright company="Nick Pruehs" file="Vector2I.cs">
...
namespace Npruehs.GrabBag.Math.Vectors
{
    ...
    public struct Vector2I : IEquatable<Vector2I>
    {
        ...
        /// <summary>
        /// Computes the squared Euclidean distance between the points at <paramref name="v1"/> and <paramref name="v2"/>. Faster than <see cref="Distance(Vector2I, Vector2I)"/>.
        /// </summary>
        /// <param name="v1">
        ...
        /// <summary>
        /// Computes the squared Euclidean distance between the points denoted by this vector and <paramref name="v"/>. Faster than <see cref="Distance(Vector2I)"/>.
        /// </summary>
        /// <param name="v">
